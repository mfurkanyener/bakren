...
export function Footer() {
  const navigation = ["Kurumsal", "Hizmetler", "Projeler", "Blog", "İletişim"];
  const legal = ["KVKK", "Gizlilik Politikası", "Yasal Bilgilendirme"];

  return (
      <footer className="relative bg-mist dark:bg-cinder border-t border-gray-200 dark:border-trueGray-800">
        <Container>
          <div className="grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5 lg:grid-cols-5">
            ...
            <div className="lg:col-span-2">
              <Link
                  href="/"
                  className="flex items-center space-x-2 text-2xl font-semibold text-flame dark:text-solarGold"
              >
                <Image
                    src="/img/logo.svg"
            ...
            {/* NAVIGASYON */}
            <div>
              <h4 className="mb-3 font-semibold text-cinder dark:text-solarGold">
                Bağlantılar
              </h4>
